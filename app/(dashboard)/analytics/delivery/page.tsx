import { getAnalyticsDelivery } from '@/lib/queries/analytics.queries'
...
export const metadata = { title: 'Analytics · Delivery' }

export default async function AnalyticsDeliveryPage({
  searchParams,
}: {
  ...
  const payload = await getAnalyticsDelivery(tenant.id, params)

  return (
    <DashboardShell
      title="Delivery"
      description="Milestone completion and deliverable submission performance."
      dashboard="delivery"
