import { getAnalyticsWorkflows } from '@/lib/queries/analytics.queries'
...
export const metadata = { title: 'Analytics · Workflows' }

export default async function AnalyticsWorkflowsPage({
  searchParams,
}: {
  ...
  const payload = await getAnalyticsWorkflows(tenant.id, params)

  return (
    <DashboardShell
      title="Workflows"
      description="Automation run volume, failures, retries, and duration."
      dashboard="workflows"
