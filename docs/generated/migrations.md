...
| 021 | [`021_event_platform.sql`](../../supabase/migrations/021_event_platform.sql) | Phase: Event Platform — atomic claiming, processing fingerprints, job claim RPC |

**Total:** 21 migrations — apply in filename order
